...
// if(!is_login() && get_action() != 'login' && get_action() != 'register' && get_action() != 'active'  && get_action() != 'reset' && get_action() != 'reset_success'){
//     redirect_to("?mod=users&contronller&action=login");
// }
