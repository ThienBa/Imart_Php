                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="?mod=menu&controller=index&action=edit&id=1" title="Sửa"
                                                    class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            </li>
                                            <li><a href="?mod=menu&controller=index&action=delete&id=1" title="Xóa"
                                                    class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </li>
                                        </ul>
                                    </td>
                                    <td style="text-align: center;"><span
                                            class="tbody-text">https://www.facebook.com</span></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="?mod=menu&controller=index&action=edit&id=2" title="Sửa"
                                                    class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            </li>
                                            <li><a href="?mod=menu&controller=index&action=delete&id=2" title="Xóa"
                                                    class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </li>
                                        </ul>
                                    </td>
